...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex bg-[#030712] text-slate-100 overflow-hidden relative">
            ...
            <div className="grid grid-cols-3 gap-3.5">
              ...
              <div className="p-3 rounded-2xl bg-slate-900/40 border border-slate-800/80 space-y-2.5 text-left">
                ...
                <div className="p-2 rounded-xl bg-slate-950/60 border border-slate-800 shadow-sm space-y-2 opacity-50">
                  ...
                  <div className="h-1.5 w-1/2 rounded bg-slate-855" />
                </div>
              </div>
            </div>
          </div>
      ...
      {/* RIGHT SIDE: Interactive Register Form (Full width on mobile, 38% or 42% on desktop) */}
        ...
        <div className="w-full max-w-md">
          ...
          <div className="hidden lg:block mb-8">
            ...
            <p className="text-xs text-slate-400 mt-2 font-medium">
              Get started for free. Register your profile details.
            </p>
          </div>
          ...
          <GlassCard className="p-8 border-slate-800/80 shadow-2xl relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-12 py-2.5 rounded-xl border border-slate-800 bg-slate-950/40 text-slate-200 focus:border-violet-500 focus:ring-1 focus:ring-violet-500 transition-all text-sm placeholder:text-slate-600"
                  />
                  <button
                    type="button"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-800 bg-slate-950/40 text-slate-200 focus:border-violet-500 focus:ring-1 focus:ring-violet-500 transition-all text-sm appearance-none cursor-pointer"
                  >
                    <option value="Team Member" className="bg-slate-900 text-slate-200">Team Member</option>
                    <option value="Project Manager" className="bg-slate-900 text-slate-200">Project Manager</option>
                  </select>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 px-4 bg-gradient-to-tr from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white font-bold rounded-xl text-sm transition-all focus:ring-2 focus:ring-violet-500/20 active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none flex items-center justify-center gap-2 mt-4 shadow-lg shadow-violet-600/10"
              >
                {loading ? (
                  <>
